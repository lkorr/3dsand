...
const TUNING_SCHEMA = [
...

  {
    ...
    params: [
      ...
      {k:'fluidFoam', n:'foam amount', d:'How strongly fast-moving surface whitens into foam and streaks.', min:0, max:2, step:0.01},
      {k:'fluidFoamSpeed', n:'foam speed', d:'Surface speed at which churn foam saturates. Lower = even gentle sloshing foams; higher = only violent splashes whiten.', min:1, max:90, step:0.5, u:'vox/s'},
