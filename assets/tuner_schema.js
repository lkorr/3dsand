...
const TUNING_SCHEMA = [
  {
    ...
    params: [
      ...
      {k:'ledgeHangDrop', n:'hang drop', d:'How far below the held lip the top of the head settles while dangling (arms extended overhead). Cosmetic-physical: deeper reads as a longer stretch, and it is also where every pull-up starts from.', min:0, max:1, step:0.01, u:'m'},
      ...
      {k:'ledgeMantleSpeed', n:'pull-up speed', d:'How fast the body pulls itself onto a standable lip after a ledge grab, and how fast it settles into the dead hang. Same committed, sweep-driven mantle the water climb-out uses — it cannot overshoot and cannot penetrate a changed world.', min:0.1, max:20, step:0.1, u:'m/s'},
