...
SPEC = [
    ...
    ("render", "waveDispersion", "TUNE_WAVE_DISPERSION", "f", 1.0),
    ("render", "waveSteepness", "TUNE_WAVE_STEEPNESS", "f", 0.55),
    ("render", "waveShoreDepth", "TUNE_WAVE_SHORE_DEPTH", "f", 0.45),
    ("render", "waveFlowScale", "TUNE_WAVE_FLOW_SCALE", "f", 1.0),
    ("render", "waveFoamThreshold", "TUNE_WAVE_FOAM_THRESHOLD", "f", 0.12),
    ("render", "waveFoamGain", "TUNE_WAVE_FOAM_GAIN", "f", 3.0),
