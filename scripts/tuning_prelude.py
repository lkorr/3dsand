...
SPEC = [
    ...
    ("sim", "fluidStiffness", "TUNE_FLUID_STIFFNESS", "f", 5400.0),
    ...
    ("sim", "fluidCohesion", "TUNE_FLUID_COHESION", "f", 90.0),
    ("sim", "fluidAttractSame", "TUNE_FLUID_ATTRACT_SAME", "f", 45.0),
    ("sim", "fluidAttractDiff", "TUNE_FLUID_ATTRACT_DIFF", "f", -90.0),
    ("sim", "fluidViscosity", "TUNE_FLUID_VISCOSITY", "f", 1.5),
