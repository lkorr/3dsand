...
SPEC = [
    ...
    ("render", "fluidFoam", "TUNE_FLUID_FOAM", "f", 0.35),
    ...
    ("sim", "fluidRestDensity", "TUNE_FLUID_REST_DENSITY", "i", 524288),
    ("sim", "fluidEosPower", "TUNE_FLUID_EOS_POWER", "i", 4),
    ("sim", "fluidCohesion", "TUNE_FLUID_COHESION", "i", 6554),
    ("sim", "fluidAttractSame", "TUNE_FLUID_ATTRACT_SAME", "i", 3277),
    ("sim", "fluidAttractDiff", "TUNE_FLUID_ATTRACT_DIFF", "i", -6554),
    ("sim", "fluidViscosity", "TUNE_FLUID_VISCOSITY", "i", 6554),
    ("sim", "fluidDamping", "TUNE_FLUID_DAMPING", "i", 0),
