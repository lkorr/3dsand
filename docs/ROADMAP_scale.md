...
>
> **[LANDED 2026-08-24] §3.2d is BUILT: `particlesActive` no longer holds
> §3.4's settled-tick skip off for 400 ticks after every explosion. ACTIVE
> scenario `CA skipped on 0/120 → 45/120`, CA −16.7%, total sim GPU −13.2%,
> hash `7cfa2420` unchanged. Gate `ca-skip`.**
